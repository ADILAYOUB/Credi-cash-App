...
class HomeScreen2 extends BaseRoute {
  ...
  List<String> loanNames = ['Instant Loan', 'Personal Loan', 'Business Loan', 'Credit Card', 'Home Loan', 'Loan against property', 'Other Loan', 'Other Services'];
  List<String> iconList = ['assets/bank.svg', 'assets/businessman-and-dollar-coin-svgrepo-com.svg', 'assets/business-svgrepo-com.svg', 'assets/card.svg', 'assets/bank.svg', 'assets/Group 650.svg', 'assets/otherloan.svg', 'assets/otherloanservice.svg'];
  List<String> titleList = ['Credit Card', 'Business Loan', 'Home Loan', 'Loan against property', 'Other Loan', 'Other Services'];
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${loanNames[index]}',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(fontSize: 11, color: Colors.black, fontWeight: FontWeight.normal),
                                              )
                                            ],
                                          ),
                                        )),
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          decoration: BoxDecoration(color: Colors.yellow, image: DecorationImage(image: AssetImage('assets/homescreen.jpg'), fit: BoxFit.cover)),
                          width: 110,
                          height: 80,
                        ),
                      ))
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text('ebook for ', style: Theme.of(context).textTheme.titleLarge),
                                  ],
                                ),
                              ],
                            ),
